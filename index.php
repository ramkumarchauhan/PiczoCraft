...
<body>
    <div id="jumbotron" class="w-100 py-4 px-5">
        <h1 class="text-center" id="app-title"><strong>PiczoCraft</strong></h1>
        <div id="app-description" class="py-2">Discover a Collection of Free Image Stacks on PiczoCraft. All media on this site is sourced through the <b>pexels.com</b> API. Uncover a world of captivating visuals at your fingertips!</div>
        <div id="seachbox-container" class="mt-5">
            <div class="mb-3">
                <input type="search" id="search" placeholder="Search Here..." class="form-control form-control-lg rounded-pill" aria-label="Search input" value="<?= $search ?>">
            </div>
        </div>
    </div>
    <div class="container-lg py-5">
        <div class="d-flex justify-content-center mb-3">
            <?php if($page != 1): ?>
                <a class="btn btn-sm btn-primary rounded-pill px-4" href="./?<m?= ((!epty($search)) ? "search={$search}" : "") ?><?= (empty($search) ? "?page=" : "&page=") ?><?= intval($page) - 1 ?>">Previous</a>
            <?php endif; ?>
        </div>
